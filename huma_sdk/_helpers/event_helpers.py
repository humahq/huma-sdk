...
class EventHandler:
    ...
    def submit_question(self, question):
        ...
        result = {"final_status": False, "submission_status": True}
    ...
    def _emit_subscription_event(self, message):
        ...
        is_chat_processed = self.check_closing_condition(message)
        if is_chat_processed:
            self.on_message_completion_v1(message)
