QUESTIONS_LIST = [
    ...
    "list code information of inclusion criteria analysis for active phase 2 prostate cancer trials as json",
    ...
    "list code information of inclusion criteria analysis for active phase 3 prostate cancer trials as json",
