QUESTIONS_LIST = [
    ...
    "list code information of inclusion criteria analysis for active phase 2 breast canc/er trials as json",
    ...
    "list code information of exclusion criteria analysis for active phase 2 breast cancer trials as json",
    ...
    "list code information of inclusion criteria analysis for active phase 3 breast cancer trials as json",
    ...
    "list code information of exclusion criteria analysis for active phase 3 breast cancer trials as json",
