QUESTIONS_LIST = [
    ...
    "list code information of inclusion criteria analysis for active phase 2 prostats cancer trials as json",
    ...
    "list code information of exclusion criteria analysis for active phase 2 prostats cancer trials as json",
    ...
    "list code information of inclusion criteria analysis for active phase 3 prostats cancer trials as json",
    ...
    "list code information of exclusion criteria analysis for active phase 3 prostats cancer trials as json",
